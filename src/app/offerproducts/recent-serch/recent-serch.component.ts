...
@Component({
  selector: 'app-recent-serch',
  templateUrl: './recent-serch.component.html',
  styleUrls: ['./recent-serch.component.scss']
})
export class RecentSerchComponent implements OnInit {
  public communityLogo = '../../../assets/images/';
  public newProduct = this.communityLogo + 'dailyprod1.png';
  public recentSerchData:any = [
